                    ...
                    <div class="col-md-12 pe-lg-10">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-3 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" name="course_name" />
                            ...
                            <div class="col-md-3 fv-row">
                                ...
                                <input type="number" min="1" max="6" class="form-control form-control-solid" placeholder="eg 2 hours" name="periodic_time" />
                            ...
                            <div class="col-md-3 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" name="venue_name" />
