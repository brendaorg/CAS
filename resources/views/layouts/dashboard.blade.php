...
<div class="row g-5 g-xl-8">
    <div class="col-xl-4">
        ...
        <div class="card bg-light-primary card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body my-3">
                <a href="#" class="card-title fw-bolder text-primary fs-5 mb-3 d-block">Full Attendance</a>
                <div class="py-1">
                    <span class="text-dark fs-1 fw-bolder me-2">76%</span>
                    <span class="fw-bold text-muted fs-7">75 Students</span>
                </div>
    ...
    <div class="col-xl-4">
        ...
        <div class="card bg-light-primary card-xl-stretch mb-5 mb-xl-8">
            <!--begin::Body-->
            <div class="card-body my-3">
                <a href="#" class="card-title fw-bolder text-primary fs-5 mb-3 d-block">Absentees</a>
                <div class="py-1">
                    <span class="text-dark fs-1 fw-bolder me-2">21%</span>
                    <span class="fw-bold text-muted fs-7">40 Students</span>
                </div>
                <div class="progress h-7px bg-primary bg-opacity-50 mt-7">
                    <div class="progress-bar bg-primary" role="progressbar" style="width: 76%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
    ...
    <div class="col-xl-4">
        ...
        <div class="card bg-light-primary card-xl-stretch mb-5 mb-xl-8">
            <!--begin::Body-->
            <div class="card-body my-3">
                <a href="#" class="card-title fw-bolder text-primary fs-5 mb-3 d-block">Average</a>
                <div class="py-1">
                    <span class="text-dark fs-1 fw-bolder me-2">16%</span>
                    <span class="fw-bold text-muted fs-7">60 Students</span>
                </div>
                <div class="progress h-7px bg-primary bg-opacity-50 mt-7">
                    <div class="progress-bar bg-primary" role="progressbar" style="width: 76%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
