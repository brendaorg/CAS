...
<div class="post d-flex flex-column-fluid" id="kt_post">
 ...
 <div id="kt_content_container" class="container-xxl">
  <div class="row g-5 g-xl-8">
    <div class="col-xl-4">
        <a href="{{ url('/dashboard/student') }}" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
            <div class="card-body">
                <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M21 10H13V11C13 11.6 12.6 12 12 12C11.4 12 11 11.6 11 11V10H3C2.4 10 2 10.4 2 11V13H22V11C22 10.4 21.6 10 21 10Z" fill="black" />
                ...
                <?php   
                 $courses =\DB::table('courses')->join('student_courses','student_courses.course_id','=','courses.id')->where('student_courses.student_id','=',\Auth::user()->id)->count();
                ?>
                <div class="text-white fw-bolder fs-2 mb-2 mt-5">Courses</div>
                <div class="fw-bold text-white"><?= $courses ?? '0'?></div>
            </div>
        </a>
    </div>
    ...
    <div class="col-xl-4">
        <a href="{{ url('/dashboard/reports') }}"  class="card bg-primary hoverable card-xl-stretch mb-xl-8">
            <div class="card-body">
                <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path opacity="0.3" d="M18 21.6C16.3 21.6 15 20.3 15 18.6V2.50001C15 2.20001 14.6 1.99996 14.3 2.19996L13 3.59999L11.7 2.3C11.3 1.9 10.7 1.9 10.3 2.3L9 3.59999L7.70001 2.3C7.30001 1.9 6.69999 1.9 6.29999 2.3L5 3.59999L3.70001 2.3C3.50001 2.1 3 2.20001 3 3.50001V18.6C3 20.3 4.3 21.6 6 21.6H18Z" fill="black" />
    ...
    <div class="col-xl-4">
        <a href="#" class="card bg-danger hoverable card-xl-stretch mb-xl-8">
            <div class="card-body">
                ...
                <?php   
                 $lcourses =\DB::table('courses')->where('courses.user_id','=',\Auth::user()->id)->count();
                ?>
                <div class="text-white fw-bolder fs-2 mb-2 mt-5">Courses</div>
                <div class="fw-bold text-white"><?= $lcourses ?? '0'?></div>
            </div>
        </a>
    </div>
